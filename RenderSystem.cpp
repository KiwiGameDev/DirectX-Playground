...
VertexBuffer* RenderSystem::createVertexBuffer(void* list_vertices, UINT size_vertices, UINT size_list, void* shader_byte_code, UINT size_byte_shader)
{
	VertexBuffer* vb = nullptr;
	
	try
	{
		vb = new VertexBuffer(list_vertices, size_vertices, size_list, shader_byte_code, size_byte_shader, this);
	}
	catch (...)
	{
...
VertexShader* RenderSystem::createVertexShader(const void* shader_byte_code, size_t size_shader_byte_code)
{
	VertexShader* vs = nullptr;

	try
	{
		vs = new VertexShader(shader_byte_code, size_shader_byte_code, this);
	}
	catch (...)
	{
...
PixelShader* RenderSystem::createPixelShader(const void* shader_byte_code, size_t size_shader_byte_code)
{
	PixelShader* ps = nullptr;

	try
	{
		ps = new PixelShader(shader_byte_code, size_shader_byte_code, this);
	}
	catch (...)
	{
